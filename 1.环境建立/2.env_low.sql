...
-- TODO 2.载入数据
insert overwrite table low.user_info values ("101", "男", "1990-01-01"),
       ("102","女", "1991-02-01"),
       ("103","女", "1992-03-01"),
       ("104","男", "1993-04-01"),
       ("105","女", "1994-05-01"),
...
insert overwrite table low.sku_info values ('1', 'xiaomi 10', '1', '2020-01-01', 2000),
...
insert overwrite table low.category_info values ('1','数码'),
       ('2','厨卫'),
       ('3','户外');

insert overwrite table low.order_info values ('1', '101', '2021-09-27', 29000.00),
...
INSERT overwrite table low.order_detail values ('1', '1', '1', '2021-09-27', 2000.00, 2),
...
INSERT overwrite table low.user_login_detail VALUES ('101', '180.149.130.161', '2021-09-21 08:00:00', '2021-09-27 08:30:00'),
...
insert overwrite table low.sku_price_modify_detail values ('1', 1900, '2021-09-25'),
       ('1', 2000, '2021-09-26'),
       ('2', 80, '2021-09-29'),
       ('2', 10, '2021-09-30'),
       ('3', 4999, '2021-09-25'),
...
insert overwrite table low.delivery_info values ('1', '1', '101', '2021-09-27', '2021-09-29'),
...
insert overwrite table low.friendship_info values ('101', '1010'),
       ('101', '108'),
       ('101', '106'),
       ('101', '104'),
       ('101', '102'),
...
insert overwrite table low.favor_info values ('101', '3', '2021-09-23'),
       ('101', '12', '2021-09-23'),
       ('101', '6', '2021-09-25'),
       ('101', '10', '2021-09-21'),
       ('101', '5', '2021-09-25'),
